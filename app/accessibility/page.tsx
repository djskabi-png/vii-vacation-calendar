  ...
  return <PageShell>
    <main id="main-content">
      <article className="accessibility-statement shell">
        ...
        <section>
          <h2>כלי הנגישות</h2>
          <p>כפתור הנגישות נמצא באזור העליון של האתר. ההתאמות נשמרות במכשיר הנוכחי וניתן לאפס אותן בכל עת. הכלי הוא שכבת עזר ואינו תחליף לקוד נגיש, לתמיכה במקלדת או לטכנולוגיה מסייעת.</p>
        </section>
