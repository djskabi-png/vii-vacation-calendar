...
type Props = { searchParams: Promise<{ id?: string; mode?: string; dates?: string; from?: string; till?: string; guests?: string; rooms?: string; price?: string; source?: string }> };
...
export default async function Page({ searchParams }: Props) {
  ...
  return <>
    ...
    <BusinessPage initialSlug={property.slug} initialWorld={initialWorld} initialDates={params.dates} initialFrom={params.from} initialTill={params.till} initialGuests={params.guests} initialRooms={params.rooms} initialPrice={params.price} initialSource={params.source} />
  </>;
}
