...
export function PageShell({ children, variant = "vacation", showWorldSwitcher = true, footerTopic }: { children: ReactNode; variant?: WorldId; showWorldSwitcher?: boolean; footerTopic?: FooterTopicId }) {
  return <div className="site-page"><a className="skip-link" href="#main-content">דילוג לתוכן</a><GlobalActionFeedback /><SiteHeader variant={variant} showWorldSwitcher={showWorldSwitcher} />{children}<SiteFooter variant={variant} topic={footerTopic} /><SmartConcierge /><CookieConsent /></div>;
}
