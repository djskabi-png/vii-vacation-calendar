  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <nav aria-label="מידע ושירות"><strong>מידע ושירות</strong><Link href="/account">החשבון האישי שלי</Link><Link href="/favorites">המקומות שאהבתי</Link><Link className="footer-join-link" href="/join">פרסום והצטרפות לאתר</Link><Link href="/gift-card">גיפט קארד</Link><Link href="/corporate">אירועי חברה ורווחה</Link><Link href="/booking?action=manage">ניהול הזמנה</Link><Link href="/questions">שאלות ותשובות</Link><Link href="/guides">מגזין ומדריכים</Link><Link href="/accessibility">הצהרת נגישות</Link><Link href="/legal/terms">תקנון</Link><Link href="/legal/privacy">מדיניות פרטיות</Link><Link href="/legal/cancellation">ביטול הזמנה</Link></nav>
      </div>
