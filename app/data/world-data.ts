...
const curatedProviderProfiles: DiscoveryItem[] = [
  ...
  { id: "hagit-designed-events", world: "providers", name: "חגית אירועים מעוצבים", searchTerms: ["חגית אירועים", "עיצוב אירועים", "סדנת פרחים"], location: "יקיר והשומרון", area: "עיצוב והפקת אירועים", description: "עיצוב והפקת אירועים פרטיים ועסקיים, עיצוב חופות ושולחנות, סידורי פרחים, מיתוג וסדנאות שזירה.", features: ["עיצוב אירועים", "פרחים וחופות", "הפקה ומיתוג"], image: "/media/providers/hagit-designed-events-1.jpg", images: ["/media/providers/hagit-designed-events-1.jpg", "/media/providers/hagit-designed-events-2.jpg", "/media/providers/hagit-designed-events-3.jpg"], priceLabel: "הצעה לפי היקף העיצוב", phone: "050-923-3773", sourceUrl: "https://www.designing.co.il/", sourceName: "האתר הרשמי של חגית אירועים מעוצבים", indexable: true },
  { id: "aae-event-design", world: "providers", name: "אביחי אהרון עיצוב אירועים", searchTerms: ["אביחי אהרון", "AAE", "עיצוב קונספט", "עיצוב פרחים"], location: "לפי מיקום האירוע", area: "עיצוב אירועים וקונספט", description: "פיתוח ויישום קונספטים לאירועים פרטיים ועסקיים, סידורי פרחים, תכנון חלל ותיאום מלא עם צוות ההפקה.", features: ["פיתוח קונספט", "סידורי פרחים", "אירועים עסקיים"], image: "/media/providers/aae-event-design-1.jpg", images: ["/media/providers/aae-event-design-1.jpg", "/media/providers/aae-event-design-2.jpg", "/media/providers/aae-event-design-3.jpg"], priceLabel: "הצעה לפי קונספט וחלל", phone: "052-343-0833", sourceUrl: "https://aae.co.il/", sourceName: "האתר הרשמי של אביחי אהרון", indexable: true },
  { id: "argaman-events", world: "providers", name: "ארגמן הפקות אירועים", searchTerms: ["ארגמן", "Argaman", "הפקת אירועים", "צילום לאירועים"], location: "לפי מיקום האירוע", area: "הפקה, צילום ומיתוג", description: "הפקת אירועים עם תכנון, לוחות זמנים ותיאום צוותי צילום, בלונים, מגנטים, משחקים, מיתוג וקייטרינג.", features: ["ניהול הפקה", "צילום ומיתוג", "אירועי חברה"], image: "/media/providers/argaman-events-1.webp", images: ["/media/providers/argaman-events-1.webp", "/media/providers/argaman-events-2.webp", "/media/providers/argaman-events-3.webp"], priceLabel: "הצעה לפי היקף ההפקה", phone: "054-233-0001", sourceUrl: "https://argaman.co/event-production/", sourceName: "האתר הרשמי של ארגמן", indexable: true },
