  ...
  return (
    <PageShell variant="events">
      <main id="main-content">
        <StructuredData data={collectionSchema("מקומות לאירועים פרטיים", "מקומות לאירועים לפי אזור, כמות משתתפים וסוג האירוע.", "/events", eventPlaces.map((place) => ({ name: place.name, path: `/events/place?id=${place.slug}`, image: place.image })))} />
