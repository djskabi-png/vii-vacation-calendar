...
export function MagazineArticleView({ initialSlug = magazineArticles[0].slug, readQuery = true }: { initialSlug?: string; readQuery?: boolean }) {
  ...
  return <PageShell>
    ...
    <main id="main-content" className="magazine-article">
      <div className="shell magazine-article__crumbs"><Link href="/guides/">מגזין וי</Link><span>/</span><span>{article.category}</span></div>
...
export default function ArticlePage() { return <MagazineArticleView />; }
