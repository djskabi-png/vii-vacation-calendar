...
const curatedTranslations: Record<Exclude<SiteLanguage, "he">, Record<string, string>> = {
  en: {
    ...
    "הקלידו עיר, אזור או שם מקום": "Enter a city, region or place name",
    "ניווט בין חודשים": "Browse months",
    "הצגת החודשים הקודמים": "Show previous months",
    "הצגת החודשים הבאים": "Show next months",
    "מקומות מתאימים": "Matching places",
    "אזורים ויישובים": "Regions and towns",
    "לא מצאנו יעד או מקום מתאים.": "No matching destination or place found.",
    "מקום אירוח": "Stay",
    "מתחם אירועים": "Event venue",
    "בית ספא": "Spa",
    "חדר לפי שעה": "Hourly room",
  ...
  ru: {
    ...
    "פנוי לחמישי": "Свободно в четверг",
    "פנוי לשישי": "Свободно в пятницу",
    "אוגוסט": "Август",
    "ראש השנה": "Рош ха-Шана",
    "סוכות": "Суккот",
    ...
    "הקלידו עיר, אזור או שם מקום": "Введите город, регион или название места",
    "ניווט בין חודשים": "Навигация по месяцам",
    "הצגת החודשים הקודמים": "Показать предыдущие месяцы",
    "הצגת החודשים הבאים": "Показать следующие месяцы",
    "מקומות מתאימים": "Подходящие места",
    "אזורים ויישובים": "Регионы и города",
    "לא מצאנו יעד או מקום מתאים.": "Подходящее направление или место не найдено.",
    "מקום אירוח": "Место проживания",
    "מתחם אירועים": "Площадка для мероприятий",
    "בית ספא": "Спа",
    "חדר לפי שעה": "Почасовой номер",
    ...
    "היום": "Сегодня", "מחר": "Завтра", "סוף השבוע הקרוב": "Ближайшие выходные",
  ...
  fr: {
    ...
    "פנוי לחמישי": "Disponible jeudi",
    "פנוי לשישי": "Disponible vendredi",
    "אוגוסט": "Août",
    "ראש השנה": "Roch Hachana",
    "סוכות": "Souccot",
    "שמחת תורה": "Sim'hat Torah",
    "חג הסיגד": "Sigd",
    ...
    "הקלידו עיר, אזור או שם מקום": "Saisissez une ville, une région ou le nom d’un lieu",
    "ניווט בין חודשים": "Navigation entre les mois",
    "הצגת החודשים הקודמים": "Afficher les mois précédents",
    "הצגת החודשים הבאים": "Afficher les mois suivants",
    "מקומות מתאימים": "Lieux correspondants",
    "אזורים ויישובים": "Régions et villes",
    "לא מצאנו יעד או מקום מתאים.": "Aucune destination ni aucun lieu ne correspond.",
    "מקום אירוח": "Hébergement",
    "מתחם אירועים": "Lieu événementiel",
    "בית ספא": "Spa",
    "חדר לפי שעה": "Chambre à l’heure",
...
const finalUiTranslations: Record<Exclude<SiteLanguage, "he">, Record<string, string>> = {
  en: {
    ...
    "7 לילות": "7 nights",
    "30 לילות": "30 nights",
    "ללא גמישות": "No flexibility",
    "סוף שבוע": "Weekend",
    "סוף שבוע ארוך": "Long weekend",
    "שבוע": "Week",
    "בחירת עולם לחיפוש": "Choose a search world",
    "עולמות נוספים": "More worlds",
    "1. משך": "1. Stay length",
    "מה אורך השהייה?": "How long would you like to stay?",
    "2. חודש": "2. Month",
    "מתי תרצו לנסוע?": "When would you like to travel?",
    "3. גמישות": "3. Flexibility",
    "כמה גמישות מתאימה לכם?": "How flexible are your dates?",
    "חודש": "Month",
    "לילות": "nights",
    "יום": "day",
    "ימים": "days",
    "החיפוש הגמיש מוכן": "Your flexible search is ready",
    "חברות": "Corporate",
  ...
  ru: {
    ...
    "7 לילות": "7 ночей",
    "30 לילות": "30 ночей",
    "ללא גמישות": "Без гибкости",
    "סוף שבוע": "Выходные",
    "סוף שבוע ארוך": "Длинные выходные",
    "שבוע": "Неделя",
    "בחירת עולם לחיפוש": "Выберите раздел поиска",
    "עולמות נוספים": "Другие разделы",
    "1. משך": "1. Продолжительность",
    "מה אורך השהייה?": "На какой срок вы хотите поехать?",
    "2. חודש": "2. Месяц",
    "מתי תרצו לנסוע?": "Когда вы хотите поехать?",
    "3. גמישות": "3. Гибкость",
    "כמה גמישות מתאימה לכם?": "Насколько гибкие у вас даты?",
    "חודש": "Месяц",
    "לילות": "ночей",
    "יום": "день",
    "ימים": "дней",
    "החיפוש הגמיש מוכן": "Гибкий поиск готов",
    "חברות": "Для компаний",
  ...
  fr: {
    ...
    "7 לילות": "7 nuits",
    "30 לילות": "30 nuits",
    "ללא גמישות": "Aucune flexibilité",
    "סוף שבוע": "Week-end",
    "סוף שבוע ארוך": "Long week-end",
    "שבוע": "Semaine",
    "בחירת עולם לחיפוש": "Choisir un univers de recherche",
    "עולמות נוספים": "Autres univers",
    "1. משך": "1. Durée",
    "מה אורך השהייה?": "Combien de temps souhaitez-vous partir ?",
    "2. חודש": "2. Mois",
    "מתי תרצו לנסוע?": "Quand souhaitez-vous partir ?",
    "3. גמישות": "3. Flexibilité",
    "כמה גמישות מתאימה לכם?": "Quelle flexibilité souhaitez-vous ?",
    "חודש": "Mois",
    "לילות": "nuits",
    "יום": "jour",
    "ימים": "jours",
    "החיפוש הגמיש מוכן": "Votre recherche flexible est prête",
    "חברות": "Entreprises",
...
const spaBookingTranslations: Record<Exclude<SiteLanguage, "he">, Record<string, string>> = {
  en: {
    ...
    "מספר המשתתפים הותאם לחבילה שבחרתם": "The guest count matches your selected package",
    "\u05d2\u05d1\u05e8": "Man",
    "\u05d0\u05d9\u05e9\u05d4": "Woman",
    ...
    "בדיוק כמו בספא פלוס: בוחרים הרכב, תאריך ושעה מועדפת, ואז ממשיכים לפרטי המזמין.": "Just like on Spa Plus: choose the guests, date and preferred time, then continue to the booking details.",
    "החבילה שבחרתם": "Your selected package",
    "החבילה שנבחרה": "Selected package",
    "משך הטיפול": "Treatment duration",
    "בחרו שעה מועדפת": "Choose a preferred time",
    "לאחר חיבור מערכת ספא פלוס יוצגו כאן רק השעות הפנויות בפועל.": "Once the Spa Plus system is connected, only genuinely available times will appear here.",
    "גמישים בשעה": "Flexible time",
    "מתאים ל": "Suitable for",
    "מה כלול": "What is included",
    "מקום וחבילה": "Spa and package",
    "בחרו תאריכי שהייה": "Choose your stay dates",
    "תחילה הגעה, אחר כך עזיבה": "Select arrival first, then departure",
    "בחרו יום פנוי בלוח": "Choose a date from the calendar",
    "בחרו תאריך": "Choose a date",
    "בחרו תאריך ושעה מועדפת.": "Choose a date and preferred time.",
    "בחרו תאריך הגעה ועזיבה ושעה מועדפת.": "Choose arrival and departure dates and a preferred time.",    "מועד והרכב": "Appointment and guests",
  },
  ru: {
    ...
    "מספר המשתתפים הותאם לחבילה שבחרתם": "Количество гостей соответствует выбранному пакету",
    "\u05d2\u05d1\u05e8": "Мужчина",
    "\u05d0\u05d9\u05e9\u05d4": "Женщина",
    ...
    "בדיוק כמו בספא פלוס: בוחרים הרכב, תאריך ושעה מועדפת, ואז ממשיכים לפרטי המזמין.": "Как в Spa Plus: выберите состав гостей, дату и желаемое время, затем перейдите к данным заказчика.",
    "החבילה שבחרתם": "Выбранный пакет",
    "החבילה שנבחרה": "Выбранный пакет",
    "משך הטיפול": "Продолжительность процедуры",
    "בחרו שעה מועדפת": "Выберите желаемое время",
    "לאחר חיבור מערכת ספא פלוס יוצגו כאן רק השעות הפנויות בפועל.": "После подключения системы Spa Plus здесь будут показаны только действительно свободные часы.",
    "גמישים בשעה": "Гибкое время",
    "מתאים ל": "Подходит для",
    "מה כלול": "Что включено",
    "מקום וחבילה": "Спа и пакет",
    "בחרו תאריכי שהייה": "Выберите даты проживания",
    "תחילה הגעה, אחר כך עזיבה": "Сначала выберите дату заезда, затем выезда",
    "בחרו יום פנוי בלוח": "Выберите дату в календаре",
    "בחרו תאריך": "Выберите дату",
    "בחרו תאריך ושעה מועדפת.": "Выберите дату и желаемое время.",
  ...
  fr: {
    ...
    "מספר המשתתפים הותאם לחבילה שבחרתם": "Le nombre de participants correspond à la formule choisie",
    "\u05d2\u05d1\u05e8": "Homme",
    "\u05d0\u05d9\u05e9\u05d4": "Femme",
    ...
    "בדיוק כמו בספא פלוס: בוחרים הרכב, תאריך ושעה מועדפת, ואז ממשיכים לפרטי המזמין.": "Comme sur Spa Plus : choisissez les participants, la date et l’heure souhaitée, puis renseignez les coordonnées de réservation.",
    "החבילה שבחרתם": "Votre formule",
    "החבילה שנבחרה": "Formule sélectionnée",
    "משך הטיפול": "Durée du soin",
    "בחרו שעה מועדפת": "Choisissez l’heure souhaitée",
    "לאחר חיבור מערכת ספא פלוס יוצגו כאן רק השעות הפנויות בפועל.": "Une fois le système Spa Plus connecté, seuls les créneaux réellement disponibles seront affichés ici.",
    "גמישים בשעה": "Horaire flexible",
    "מתאים ל": "Convient à",
    "מה כלול": "Inclus",
    "מקום וחבילה": "Spa et formule",
    "בחרו תאריכי שהייה": "Choisissez vos dates de séjour",
    "תחילה הגעה, אחר כך עזיבה": "Choisissez d’abord l’arrivée, puis le départ",
    "בחרו יום פנוי בלוח": "Choisissez une date dans le calendrier",
    "בחרו תאריך": "Choisissez une date",
    "בחרו תאריך ושעה מועדפת.": "Choisissez une date et une heure.",
    "בחרו תאריך הגעה ועזיבה ושעה מועדפת.": "Choisissez les dates d’arrivée et de départ, puis une heure.",    "מועד והרכב": "Horaire et participants",
  },
};
