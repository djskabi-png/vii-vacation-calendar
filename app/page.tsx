  ...
  return (
    <div className="live-page home-live-page" dir="rtl">
      ...
      <main id="main-content">
        <section className="home-search-section" aria-labelledby="home-title">
          ...
          <div className="real-search-bar" aria-label="חיפוש נופש">
            ...
            <button type="button" className="main-search-button" onClick={() => setSearchReady(true)} aria-label="חיפוש">
        ...
        <section className="home-section recommended-section" aria-labelledby="recommended-title">
          <div className="section-heading">
            <div>
          ...
          <div className="property-card-grid">
            {RECOMMENDED.map((item) => (
              <article className="property-card" key={item.name}>
                <div className="property-card-image"><img src={item.image} alt={item.name} /><button type="button" aria-label={`הוספת ${item.name} למועדפים`}>♡</button></div>
                ...
                {item.businessDemo ? (
                  <a className="card-action" href="./business/">לצפייה בהמחשת דף העסק</a>
                ) : (
                  <a className="card-action muted" href="https://www.vii.co.il/" target="_blank" rel="noreferrer">לצפייה באתר הפעיל</a>
                )}
              </article>
            ))}
          </div>
