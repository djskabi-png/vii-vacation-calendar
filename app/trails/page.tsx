...
export default function TrailsPage() {
  return <PageShell variant="activities">
    <main id="main-content" className="trails-page">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "ItemList", name: "מסלולי טיול בישראל למטייל העצמאי", numberOfItems: trails.length, itemListElement: trails.map((trail, index) => ({ "@type": "ListItem", position: index + 1, name: trail.name, url: `https://vii.spaplus.co/trails/${trail.slug}/` })) }) }} />
